                ...
                <div class="page-title-box">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <button style="margin-left: 30px" type="button" class="btn btn-success waves-effect waves-light">Thêm dịch vụ</button></a> 
                            <h4 style="padding-left: 430px" class="page-title m-0">Danh sách dịch vụ</h4>
                            <p>&nbsp;</p>
                            </div>                            
                        </div>
                        <!-- end col -->
