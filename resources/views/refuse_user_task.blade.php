...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            <table class="table mb-0"><h5>Công việc bị từ chối</h5>
                <thead>
                    <tr>                     
                        <th>Dự án</th>
                        <th>Công việc</th>
                    ...
                    @foreach($all_task as $key => $value)
                       ...
                       <th> @foreach($all_employee as $key)
                        ...
                        <td>
                            ...
                            ?>
                                  <a href="{{URL::to('/start-user-task/'.$value->task_id)}}"><button type="button" style="width:130px;" class="btn btn-warning waves-effect waves-light">Bắt đầu lại</button></a>
                            <?php
                            }
                            ?>
                            </span>
